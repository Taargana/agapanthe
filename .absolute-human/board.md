...
- 2026-07-10: W4/M7-05 done — skybox (fusionné scène) + set 0 IBL 3/4/5 + ambiant IBL mesh.frag. Captures helmet (reflets+ciel) et MetalRoughSpheres OK, 0 validation, 0 leak, 180 tests. Prochain: W5/M7-06 (Sandbox arg HDRI + protocole visuel MetalRoughSpheres vs viewer Khronos) + tail W6 (audits/verif).
