...
**Status**: **CLOSED** — 2026-07-13. **P2-M2 LIVRÉ** : la couture ECS est en place (Scene débranchée en `ResourceRegistry` + `GameWorld`/Arch ; rendu par handles + 2 listes passthrough). **Critère de sortie TENU** : capture **Debug ET NativeAOT byte-identique** à la baseline M8 (`24001B24…`) → refactor **pur**. Double audit **PASS** (0 critique), 234 tests 5/5, 0 leak, 0 validation, 0 warning. Archivé → `archive/board-session11-P2M2.md`. **Prochain : P2-M3** (camera-relative). Commits : `f579074` · `899312e` · `3640bc3` · `e383713` · `c9a7c21` · `01c7e49`.
**Créé**: 2026-07-13
