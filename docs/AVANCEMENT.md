...
>
> ### ▶️ Reprise — **Contenu-3b** (`.agscene`/`.agprefab` + `SceneLoader`), ou 2ᵉ slice dissemblable, ou UI-3
> Feu vert humain requis avant **3b**. Alternatives : **2ᵉ slice dissemblable** (top-down) · **UI-3**
> (timestamps GPU + seam `FrameProfiler`).
>
