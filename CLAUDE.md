...
**Prochain (session 16+)** : d'abord le **fix Sandbox approuvé mais non appliqué** (grille de casques : couper le rig studio en multi-instances, plafonner `ShadowDistance` — voir `docs/AVANCEMENT.md` § Reprise), puis **P3-M0 validation Linux/macOS** (les titres AOT + SPIR-V hors-ligne sont **prouvés Windows uniquement**), ou **P3-M3 physique** (dépendances toutes payées), ou le rendu GPU-driven reporté de P3-M1. Détail + point de reprise dans `docs/AVANCEMENT.md`.
